        ...
        <Container className = "PortfolioPage"> 
                ...
                <Row> 
                    ...
                    <Col className="ContentCol" md={8}> 
                            ...
                            I'm currently working on a project called 'Decrypted By Us', a Youtube channel and community designed to make technical education more accessible to minority groups, 
